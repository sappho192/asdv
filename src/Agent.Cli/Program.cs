    ...
    CancellationToken ct)
{
    ...
    var options = new AgentOptions
    {
        ...
        MaxTokens = 4096,
        SystemPrompt = GetSystemPrompt(toolRegistry, repoRoot, envInfo),
        State = sessionState,
        IsResumed = resumed
    };
...
static string GetSystemPrompt(ToolRegistry toolRegistry, string repoRoot, EnvironmentDetector.EnvironmentInfo? envInfo = null)
{
